...
def create_network_labeled_logs_from_txt(raw_data_dir, processed_logs_dir):
...
raw_data_dir = os.path.join(project_root, 'target_dataset', '1-raw_datasets', 'net')
processed_logs_dir = os.path.join(project_root, 'target_dataset', '2-processed_datasets', 'net')
...
create_network_labeled_logs_from_txt(raw_data_dir, processed_logs_dir)